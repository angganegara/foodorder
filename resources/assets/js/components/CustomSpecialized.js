...
const diets = [
  ...
  {
    title: 'CANDIDA DIET',
    body: '<ul><li>Help balance the overproduction of candida</li><li>Sugar, gluten and dairy free</li><li>Includes probiotic foods</li></ul>'
  },
  {
    title: 'HORMONE DIET',
    body: '<ul><li>Rich in food that can raise your progesterone levels</li><li>Help stabilize the hormonal balance</li><li>Lead to better sleep</li><li>Improve mood</li><li>Increase energy</li><li>Improve libido</li><li>Weight loss</li><li>Reduce cravings</li></ul>'
  },
  {
    title: 'THYROID DIET',
  ...
  {
    title: 'AYUVERDA MENU',
    body: '<ul><li>Based on the Ayurveda principals</li><li>Based on your &ldquo;Dosha&rdquo; &ndash; Vata, Pitta or Kapha</li><li>Health is defined as the dynamic state of a balanced mind, body and environment</li></ul>'
  }
];
      ...
      <div className="row">
        ...
        <div className="col-md-10">
          ...
          <div className="details--description">
            ...
            <br />
            <p><a href="#" title="" className="custom-btn"><i className="fa fa-fw fa-arrow-circle-down"></i> Download Questionnaire PDF</a></p>
            <br />
            <p><strong>Please find below some existing diets for special needs, that have proven great success.</strong></p>
          </div>
        </div>
      </div>
    </div>
        ...
        <div className="col-md-offset-1 col-md-11">
          <div className="diet-wrap">
            ...
            <div className="diet-card" key={index}>
              ...
              <div className="diet-card--body" dangerouslySetInnerHTML={{__html: diet.body}}></div>
            </div>
            ))}
          </div>
        </div>
