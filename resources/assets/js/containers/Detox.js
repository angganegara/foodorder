...
class Detox extends Component {
  ...
  loadDetox = () => {
    axios.get("/api/detox").then(res => this.setState({ detox: res.data }));
  };
              ...
              <div className="row">
                ...
                <div className="col-md-6">
                  ...
                  <div
                    ...
                    dangerouslySetInnerHTML={{ __html: detox.description }}
                  />
                </div>
              </div>
            </div>
                      ...
                      <div className="col-xs-12 col-md-6 blue-line" key={index}>
                        <div className="detox-card">
                          ...
                          >
                            <figure>
                              <img
                                src={`/images/foods/thumb_${dt.id}.jpg`}
                                alt=""
                              />
                            </figure>
